...
export function createEnterpriseController(ctx, options = {}) {
  ...
  const handleCallback = async (request, response, expectedFlow) => {
    ...
    try {
      ...
      response.writeHead(200).end(callbackPage(true, '授权已完成，页面将自动返回毕昇首页。', expectedFlow.base))
